...
TRANSLATIONS = {
    "en": {
        ...
        "warning": "Warning",
        "error": "Error",
        "select_standard_first": "Please select a standard PDF first.",
        "select_reports_first": "Please select reports first.",
        "parse_reports_first": "Please parse reports first.",
        "standard_embeddings_not_ready": "Standard embeddings not ready.",
        "no_parsed_reports": "No parsed reports available for matching.",
        "processing_report": "Processing report {current}/{total}: {name}",
        "export_requirements": "Export Requirements",
        "export_paragraphs": "Export Report Paragraphs",
        "standard_changed_reports_preserved": "Standard updated. Reports preserved. Re-run matching to update results.",
    },
    "de": {
        ...
        "warning": "Warnung",
        "error": "Fehler",
        "select_standard_first": "Bitte zuerst eine Standard-PDF auswählen.",
        "select_reports_first": "Bitte zuerst Berichte auswählen.",
        "parse_reports_first": "Bitte zuerst die Berichte parsen.",
        "standard_embeddings_not_ready": "Standard-Embeddings sind nicht bereit.",
        "no_parsed_reports": "Keine geparsten Berichte für den Abgleich verfügbar.",
        "processing_report": "Bericht wird verarbeitet {current}/{total}: {name}",
        "export_requirements": "Anforderungen exportieren",
        "export_paragraphs": "Bericht-Absätze exportieren",
        "standard_changed_reports_preserved": "Standard aktualisiert. Berichte beibehalten. Matching bitte erneut ausführen.",
    },
}
